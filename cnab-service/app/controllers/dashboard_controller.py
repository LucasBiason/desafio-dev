...
class DashboardController:
    ...
    def get_balance_by_store(self) -> BalanceByStoreResponse:
    ...
    def get_transactions_by_type(self) -> TransactionsByTypeResponse:
    ...
    def get_transactions_timeline(self) -> UploadsTimelineResponse:
